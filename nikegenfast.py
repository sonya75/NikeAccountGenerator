...
def signup(email,NUMBER,name,password,country):
    ...
    if country=="US":
        payload={"account":{"email":email,"passwordSettings":{"password":password,"passwordConfirm":password}},"locale":"en_US","welcomeEmailTemplate":"TSD_PROF_MS_WELC_T0_GENERIC_V1.0","registrationSiteId":"nikedotcom","username":email,"firstName":nam[0],"lastName":nam[1],"dateOfBirth":dob,"country":"US","gender":"F","receiveEmail":True,'client_id':'PbCREuPr3iaFANEDjtiEzXooFl7mXGQ7','ux_id':'com.nike.commerce.snkrs.droid'}
    else:
    ...
    r=sess.post("https://api.nike.com/idn/shim/profile/services/users",json=payload,verify=False,proxies={"https":prox},timeout=30)
    r.raise_for_status()
